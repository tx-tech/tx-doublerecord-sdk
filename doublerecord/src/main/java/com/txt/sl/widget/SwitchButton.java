...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        uncheckTextColor = optColor(typedArray, R.styleable.SwitchButton_sb_unchecked_textcolor, Color.WHITE);
    ...
    protected void drawCheckedIndicator(Canvas canvas) {
        drawCheckedIndicator(canvas,
                ...
                checkLineWidth,
                left + checkedLineOffsetX*2, top + centerY,
...
//        paint.setStrokeWidth(lineWidth);
        canvas.drawText("否",
                buttonRadius * 2 + checkedLineOffsetX*2, top + centerY,
                paint);
    }

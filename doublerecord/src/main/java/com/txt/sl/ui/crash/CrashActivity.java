...
import com.txt.sl.R;
import com.txt.sl.config.AppConfig;
...
public final class CrashActivity extends BaseActivity implements View.OnClickListener {
    ...
    public int getLayoutId() {
        return R.layout.tx_crash_activity;
    }
    ...
    public void initView() {
        ...
        // 设置状态栏沉浸
        TxImmersionBar.setTitleBar(this, findViewById(R.id.ll_crash_bar));
        TxImmersionBar.setTitleBar(this, findViewById(R.id.ll_crash_info));
    }
...
//            if (permissions.contains(TxPermissionConstants.MANAGE_EXTERNAL_STORAGE)) {

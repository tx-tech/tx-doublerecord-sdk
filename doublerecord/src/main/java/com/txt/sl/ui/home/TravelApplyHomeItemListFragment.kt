...
class TravelApplyHomeItemListFragment : BaseLazyViewPagerFragment(), CheckRemoteDialog.OnRemoteClickListener {
...
//                }
    ...
    override fun onConfirmClick(isRemote: Boolean, flowId: String, phone :String, taskId:String, membersArray :ArrayList<String>) {

        if (isRemote){
            InviteActivity.newInstance(_mActivity,isRemote,flowId,phone,taskId,membersArray)
        }else{
            InviteActivity.newInstance(_mActivity,isRemote,flowId,phone,taskId,membersArray)
//            requestRoom(false,flowId,membersArray)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(applyStatusParams: String?): TravelApplyHomeItemListFragment {
            val fragment = TravelApplyHomeItemListFragment()
            val args = Bundle()

...
-keep class com.common.widget.base.** { *; }
-dontwarn com.common.widget.base.**

-keep class com.txt.sl.entity.constant.**{*;}
-keep class com.txt.sl.entity.bean.**{*;}
